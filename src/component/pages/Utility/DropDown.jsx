...
const Dropdown = ({ isOpen }) => {
  return (
    <div className="flex items-center justify-center bg-gray-50">
      <div
        className={`absolute top-full mt-2 p-10 h-[270px] text-left w-[500px] backdrop-blur-lg bg-slate-50/95 text-gray-800 shadow-lg rounded-3xl transform transition-all duration-300 ease-in-out z-50 ${
          // Added z-50 to bring the dropdown to the front
          isOpen
